...
>
    ...
    <button
        on:click={() => srchClear()}
    >
        <svg class="dark:fill-white fill-black sm:w-5 w-3 mr-2 " version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490 490" xml:space="preserve">
