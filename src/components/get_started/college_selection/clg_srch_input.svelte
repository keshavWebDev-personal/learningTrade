...
<div
    class="lg:w-96 lg:h-14 lg:p-3 md:text-lg text-sm sm:w-80 sm:h-12  sm:p-2 w-1/2 h-10 p-1 rounded-full b bg-gradient-to-r from-[#FFF7AD] to-[#FFA9F9] flex items-center justify-between dark:border dark:border-[#3d3d3d] dark:from-[#372d37c2]  dark:to-[#525252c2] gap-2 "
>
    <div
